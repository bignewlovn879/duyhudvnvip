 ...
 AutoW:OnChanged(function(Value)
  ...
  spawn(function()
	...
	spawn(function()
        ...
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Đánh Nhà Máy", Default = false })
...
CamShake:Stop()
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Dịch chuyển Fram", Default = false })
